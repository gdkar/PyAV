...
#  @return (AVRational) d
# /
    cdef AVRational av_d2q(double d, int _max) ;

##
#  @return 1 if q1 is nearer to q than q2, -1 if q2 is nearer
#  than q1, 0 if they have the same distance.
# /
    cdef int av_nearer_q(AVRational q, AVRational q1, AVRational q2);
...
# /
    cdef int av_find_nearest_q_idx(AVRational q, const AVRational* q_list);
...
# /
cdef inline AVRational av_make_q(int num, int den):
    cdef AVRational r
    r.num = num
    r.den = den
    return r
...
cdef inline int av_cmp_q(AVRational a, AVRational b):
    cdef int64_t tmp = a.num * <int64_t>b.den - b.num * <int64_t>a.den
    if tmp:return <int>((tmp ^ a.den ^ b.den)>>63) | 1;
    elif a.den and b.den: return 0
    elif a.num and b.num: return (a.num >> 31) - (b.num >> 31)
    else: return INT_MIN
...
#  @return (double) a
# /
cdef inline double av_q2d(AVRational a):
